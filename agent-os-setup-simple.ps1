# Agent OS Base Installation Script - Simple PowerShell Version
...
if ($Help) {
    Write-Host ""
    Write-Host "Usage: .\agent-os-setup-simple.ps1 [OPTIONS]"
    Write-Host ""
    Write-Host "Options:"
...
Write-Host ""
Write-Host "🚀 Agent OS Base Installation - Simple PowerShell Version"
Write-Host "========================================================"
Write-Host ""
...
if (!(Test-Path $configPath)) {
    ...
    # Create config content line by line to avoid YAML parsing issues
    $configLines = @(
