# Agent OS Base Installation Script - Working PowerShell Version
...
if ($Help) {
    Write-Host ""
    Write-Host "Usage: .\agent-os-setup-working.ps1 [OPTIONS]"
    Write-Host ""
    Write-Host "Options:"
...
Write-Host ""
Write-Host "🚀 Agent OS Base Installation - Working PowerShell Version"
Write-Host "========================================================="
Write-Host ""
...
if (!(Test-Path $configPath)) {
    ...
    # Create config content as a single string
    $configContent = @"
