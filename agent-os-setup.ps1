...
if ($Help) {
    Write-Host ""
    Write-Host "Usage: .\agent-os-setup.ps1 [OPTIONS]"
    Write-Host ""
    Write-Host "Options:"
...
Write-Host ""
Write-Host "🚀 Agent OS Base Installation - PowerShell Version"
Write-Host "=================================================="
Write-Host ""
...
function Download-File {
    ...
    try {
        ...
        Write-Host "  ❌ Failed to download $Description`: $($_.Exception.Message)"
        return $false
    }
}
...
standards:
  ...
  react:
    ...
    file: "react-style.md"
"@
    Set-Content -Path $configPath -Value $basicConfig
